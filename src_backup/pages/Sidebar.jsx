...
function Sidebar() {
  ...
  const archives = [
    { title: "Archive 1", url: "/archive1" },
    { title: "Archive 2", url: "/archive2" },
  ];
  ...
  const profile = {
    ...
    description: "Teacher at XYZ School",
  };
  ...
  const title = "Classroom Activities";
  const description = "A summary of student activities.";
  return (
    <Box >
      {/* New Title */}
